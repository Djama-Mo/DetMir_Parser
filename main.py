...
MSK = '/html/body/div[5]/div[4]/div/div/div[2]/div/div[2]/div/ul/li[11]/ul/li[1]'
...
def main():
    ...
    print('MSK Done!')
    parser.driver.close()
    parser_spb = Parser(SPB)
    parser_spb.run()
    print('SPB Done!')
    parser_spb.driver.close()
    parser.save_result()
    parser_spb.save_result(1)
    return
